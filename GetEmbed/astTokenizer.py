...
PYTHON_LANGUAGE = Language('/home/aktarafder/Documents/SoftwareProject/HF/ASTTokenizer/build/my-languages.so', 'python')
parser = Parser()
...
class CustomTokenizer:
    ...
    def __getattr__(self, attr):
        if hasattr(self.tokenizer, attr):
            ...
            raise AttributeError(f"'CustomTokenizer' object has no attribute '{attr}'")
    '''
